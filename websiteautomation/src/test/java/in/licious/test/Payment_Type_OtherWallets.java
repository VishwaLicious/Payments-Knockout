...
public class Payment_Type_OtherWallets extends BaseTest {
	
	@Test (priority=5)
	public void testPayment_Type_OtherWallets() throws ClassNotFoundException, SQLException
	{
		...
		log.info(" Selected other wallets as payment mode ");
		etest.log(LogStatus.PASS, " Selected other wallets as payment mode ");
	...
	//	success.getRayzorpayPage().click();
		...
		log.info(" Order Placed Sucessfully with Other Wallets as payment mode ");
		etest.log(LogStatus.PASS, " Order Placed Sucessfully with Other Wallets as payment mode ");
