...
public class HandlingActiveOrder extends BaseTest {
	...
	public void testfishandseafood() throws ClassNotFoundException, SQLException
	{
		...
		log.info(userName+" Entered User Name");
		etest.log(LogStatus.PASS,userName +" Entered User Name");
		...
		System.out.println("Clicked on Fish and Seafood Category ");
		
		log.info(" Clicked on fish and seafood category ");
		etest.log(LogStatus.PASS, " Clicked on fish and seafood category ");
		
		// Add the product behind the active order from the category page
		FishandSeafoodPage fishandseafoodPage =new FishandSeafoodPage(driver);
		WebElement addtocart= fishandseafoodPage.getproduct_behind_vieworder();
	...
	//		actions.moveToElement(addtocart).click().perform();
		...
		//addtocart.click();
	//	execute_script("arguments[0].click();", addtocart);
	//	((JavascriptExecutor) driver).executeScript("arguments[0].click()", btnElem);
		
		System.out.println("Added product behind view order");
...
//		
		...
		log.info(" Selected credit and debit card as payment mode ");
		etest.log(LogStatus.PASS, " Selected credit and debit card as payment mode ");
		...
		log.info(" Order Placed Sucessfully with credit and debit card as payment mode ");
		etest.log(LogStatus.PASS, " Order Placed Sucessfully with credit and debit card as payment mode ");
	...
	private void execute_script(String string, WebElement addtocart) {
