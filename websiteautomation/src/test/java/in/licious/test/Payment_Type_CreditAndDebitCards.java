...
public class Payment_Type_CreditAndDebitCards extends BaseTest {

	@Test(priority = 3)
	public void testPayment_Type_CreditAndDebitCards() throws ClassNotFoundException, SQLException {
...
//		// Add to cart the product which is behind the View Order
...
//		System.out.println("Added the product which was behind the view order");
...
//		jse.executeScript("arguments[0].click()", addtocart1);
		...
		// Commenting the final payment on production
